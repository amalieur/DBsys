...
public class BufferPool {
    ...
    public synchronized void flushAllPages() throws IOException {
      // some code goes here
      // not necessary for lab1
      Consumer<Entry<PageId, Page>> myConsumer = (e) -> {
        try{
          this.flushPage(e.getKey());
        }
      ...
      this.bufferPool.getStream().forEach(myConsumer);
 ...
 private static class PageBufferPool {
    ...
    public Stream<Entry<PageId, Page>> getStream () {
      return this.pageIdToPage.entrySet().stream();
    }
  }
